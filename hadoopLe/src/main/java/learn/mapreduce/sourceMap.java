...
public class sourceMap extends Mapper<LongWritable, Text, Text, Text> {
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        // TODO Auto-generated method stub
        context.getCounter("Count", "sourceCount").increment(1);
        ...
        context.write(new Text(newKey), new Text("1;" + line));
    }
